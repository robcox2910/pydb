...
```bash
# Clone the repo
git clone https://github.com/robcox2910/pydb.git
cd pydb
...
| Prefix | When to use |
|--------|-------------|
| `feat/` | New feature or database component |
| `fix/` | Bug fix |
...
Example: `feat/schema`, `fix/insert-validation`
...
```
feat: add schema with column definitions
fix: reject null values in non-nullable columns
docs: add storage engine concept page
```
...
feat: adds schema      # not imperative mood ("adds" -> "add")
```
...
Open an issue on [GitHub](https://github.com/robcox2910/pydb/issues) --
we're happy to help!
